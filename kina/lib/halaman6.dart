...
class _LandscapePageState extends State<LandscapePage> {
  ...
  Future<void> _playVoiceOver() async {
    await audioPlayer.play(AssetSource('audio/hal 6.mp3'));
  }
          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('images/bghal6.jpg'),
                fit: BoxFit.cover,
              ),
            ),
          ),
             ...
             child: AnimatedTextKit(
                animatedTexts: [
                  TypewriterAnimatedText(
                    'Pada suatu waktu, di surga yang indah, Adam merasa kesepian.Melihat kesedihan Adam, Allah menciptakan Hawa sebagai pendampingnya',
