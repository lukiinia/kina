...
class Halaman17 extends StatelessWidget {
  @override
...
class _LandscapePageState extends State<LandscapePage> { // Buat State class
  ...
  Future<void> _playVoiceOver() async {
    await audioPlayer.play(AssetSource('audio/halaman17.mp3')); // Ganti dengan path audio Anda
  }
    ...
    return Scaffold(
      body: Stack(
        children: [
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('images/18.gif'),
                fit: BoxFit.cover,
              ),
            ),
          ),
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    PageRouteBuilder(
                      pageBuilder: (_, __, ___) => Halaman16(),
                      transitionsBuilder: (_, animation, __, child) {
                        return FadeTransition(
                          opacity: animation,
                          child: child,
          ...
          Positioned(
            top: height * 0.2, // Adjusted top position
            left: width * 0.1, // Adjusted left position
            right: width * 0.45, // Adjusted right position
            child: Container(
              ...
              child: AnimatedTextKit(
                animatedTexts: [
                  TypewriterAnimatedText(
                    'Allah menerima kurban Habil, dan Qabil merasa iri dan dendam.',
