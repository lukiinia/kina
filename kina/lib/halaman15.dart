...
class _LandscapePageState extends State<LandscapePage> { // Buat State class
  ...
  Future<void> _playVoiceOver() async {
    await audioPlayer.play(AssetSource('audio/halaman15.mp3')); // Ganti dengan path audio Anda
  }
               ...
               child: AnimatedTextKit(
                animatedTexts: [
                  TypewriterAnimatedText(
                    'Bersama istrinya, Hawa, mereka diberkahi dengan empat anak: Qabil, Habil, Iklima, dan Labuda. Saat mereka tumbuh dewasa, Allah menginginkan mereka menikah.',
