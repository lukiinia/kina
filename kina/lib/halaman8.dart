...
class Halaman8 extends StatelessWidget {
  @override
...
class _LandscapePageState extends State<LandscapePage> {
  ...
  Future<void> _playVoiceOver() async {
    await audioPlayer.play(AssetSource('audio/hal 8.mp3'));
  }
          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('images/bghal8.jpg'),
                fit: BoxFit.cover,
              ),
            ),
          ),
              ...
              child: AnimatedTextKit(
                animatedTexts: [
                  TypewriterAnimatedText(
                    'Kehidupan di surga sangat menyenangkan bagi Adam dan Hawa. Namun, mereka juga sadar akan satu-satunya pantangan, yaitu menjauhi pohon larangan yang Allah telah tetapkan',
