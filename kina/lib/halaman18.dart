...
import 'package:kina/halaman17.dart';
...
class Halaman18 extends StatelessWidget {
  @override
...
class _LandscapePageState extends State<LandscapePage> { // Buat State class
  ...
  Future<void> _playVoiceOver() async {
    await audioPlayer.play(AssetSource('audio/halaman18.mp3')); // Ganti dengan path audio Anda
  }
          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('images/17.gif'),
                fit: BoxFit.cover,
              ),
            ),
          ),
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    PageRouteBuilder(
                      pageBuilder: (_, __, ___) => Halaman17(),
                      transitionsBuilder: (_, animation, __, child) {
                        return FadeTransition(
                          opacity: animation,
                          child: child,
              ...
              child: AnimatedTextKit(
                animatedTexts: [
                  TypewriterAnimatedText(
                    'Qabil merasa iri dan dendam. Qabil dengan marah membunuh habil, Sebelum itu Habil dengan baik hati berkata "Tidaklah baik membunuh, Qabil. Kita harus hidup dalam damai dan saling mengasihi" Qabil langsung marah dan membunuh Habil',
