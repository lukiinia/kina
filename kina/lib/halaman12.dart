...
class Halaman12 extends StatelessWidget {
  @override
...
class _LandscapePageState extends State<LandscapePage> {
  ...
  Future<void> _playVoiceOver() async {
    await audioPlayer.play(AssetSource('audio/halaman12.mp3'));
  }
    ...
    return Scaffold(
      body: Stack(
        children: [
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('images/12.gif'),
                fit: BoxFit.cover,
              ),
            ),
          ),
          ...
          Positioned(
            top: MediaQuery.of(context).size.height * 0.49, // Adjusted top position
              ...
              child: AnimatedTextKit(
                animatedTexts: [
                  TypewriterAnimatedText(
                    'Ketika diturunkan dari surga, Adam terpisah dengan istrinya, Hawa. Adam di turunkan di India, sedangkan Hawa di Jeddah.',
