...
class _LandscapePageState extends State<LandscapePage> {
  ...
  Future<void> _playVoiceOver() async {
    await audioPlayer.play(AssetSource('audio/Hal1.mp3'));
  }
  ...
  @override
  Widget build(BuildContext context) {
    final String text = 'Allah mengadakan pertemuan dengan para malaikat dan mengungkapkan rencana-Nya untuk menciptakan Adam sebagai khalifah di bumi';
